...
export default function DayHeader({
  ...
  return (
    <div className="lg:sticky lg:top-32 z-10 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 border-b border-gray-200 dark:border-gray-700 px-4 py-3 rounded-t-xl">
      <div className="flex gap-3">
        {/* Spacer to align with timeline icon column */}
