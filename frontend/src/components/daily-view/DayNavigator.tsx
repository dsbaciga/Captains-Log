      ...
      <div className="relative" ref={dropdownRef}>
        ...
        {isDropdownOpen && (
          <div
            ...
            className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 w-[calc(100vw-2rem)] sm:w-64 max-w-64 max-h-80 overflow-y-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-20"
            onKeyDown={handleKeyDown}
          >
            <div className="p-2">
