...
export default function AlbumModal({
  ...
  const [locationId, setLocationId] = useState<number | null>(album?.locationId || null);
  const [activityId, setActivityId] = useState<number | null>(album?.activityId || null);
  const [lodgingId, setLodgingId] = useState<number | null>(album?.lodgingId || null);
