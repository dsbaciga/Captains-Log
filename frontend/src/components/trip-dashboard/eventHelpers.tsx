/**
 * Event icon component for trip dashboard.
 * Only exports React components for React Fast Refresh compatibility.
 */

import type { EventIconType } from '../../utils/tripDashboardUtils';
